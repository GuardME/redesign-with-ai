...
export default function Home() {
  return (
    <div initial='initial' animate='animate'>
      <div className='grid lg:grid-cols-12 mx-auto px-4 py-8 max-w-screen-xl'>
        <div className='lg:col-span-7 place-self-center mr-auto'>
            ...
            <button type='button' className='mt-8 neu_button_black'>Redesign Now</button>
        </div>
